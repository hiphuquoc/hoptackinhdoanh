...
@push('cssFirstView')
    ...
    @if(env('APP_ENV')=='local')
        @vite('resources/sources/main/exchange-first-view.scss')
    @else
        @php
            $manifest           = json_decode(file_get_contents(public_path('build/manifest.json')), true);
            $cssFirstView       = $manifest['resources/sources/main/exchange-first-view.scss']['file'];
        @endphp
        <style type="text/css">
        ...
        <div class="layoutPageCategoryBlog container">
            <div class="layoutPageCategoryBlog_main">
                ...
                <div class="sectionBox">
                    ...
                    <p class="sectionBox_desc">{{ $itemSeo->seo_description ?? null }}</p>
                    
                    @include('main.exchange.bussinessBox')
                </div>
